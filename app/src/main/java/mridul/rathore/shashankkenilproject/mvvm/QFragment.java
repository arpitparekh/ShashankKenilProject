...
import mridul.rathore.shashankkenilproject.databinding.FragmentQBinding;


public class QFragment extends Fragment {

    private FragmentQBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentQBinding.inflate(getLayoutInflater());
